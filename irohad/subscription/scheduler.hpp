...
namespace iroha::subscription {
  ...
  class IScheduler {
   public:
    ...
    /// Adds task that will be periodicaly called with timeout period after timeout, until predicate return true
    virtual void repeat(std::chrono::microseconds timeout, Task &&t, Predicate &&pred) = 0;
  };
