...
class RocksDBIndexerTest : public ::testing::Test {
 public:
  ...
  shared_model::crypto::Hash h_1_ = shared_model::crypto::Hash::fromHexString("0102030405");
  shared_model::crypto::Hash h_2_ = shared_model::crypto::Hash::fromHexString("1112131415");
  shared_model::crypto::Hash h_3_ = shared_model::crypto::Hash::fromHexString("2122232425");
...
TEST_F(RocksDBIndexerTest, SimpleCheckTxStatus) {
  ...
  result = forTransactionStatus<kDbOperation::kGet, kDbEntry::kCanExist>(common,
                                                                         shared_model::crypto::Hash::fromHexString("1234"));
  ASSERT_TRUE(iroha::expected::hasValue(result));
